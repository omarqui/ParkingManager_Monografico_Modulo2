...
namespace CapaPresentacion.Reportes
{
    public partial class FrmReportViwer : Form
    {
        ...
        {
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "CapaPresentacion.Reportes.RptTurno.rdlc";

            ReportDataSource configuracion = new ReportDataSource("Configuracion", ConfiguracionLG.BuscarConfiguracion());
            ReportDataSource cobro = new ReportDataSource("Turno", TurnoLG.BuscarTurnoImpresion(1));
